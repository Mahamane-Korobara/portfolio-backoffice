...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mahamane/Bureau/Mahamane/Projet_laravel/mon-api-backoffice/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mahamane/Bureau/Mahamane/Projet_laravel/mon-api-backoffice/public/storage',
...
'sanctum.csrf-cookie','articles.index','articles.store','articles.show',
'articles.update','articles.destroy','categories.index','categories.store','categories.show',
'categories.update','categories.destroy','tags.index','tags.store','tags.show',
'tags.update','tags.destroy','series.index','series.store','series.show',
'series.update','series.destroy','storage.local','storage.local.upload',);
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','ADMIN_NAME','ADMIN_EMAIL','ADMIN_PASSWORD',
'APP_DASHBOARD_URL','APP_FRONTEND_URL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',
